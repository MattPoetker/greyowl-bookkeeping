      ...
      <Container>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            <div
              key={service.title}
              className="group rounded-2xl border border-brand-lavender/30 bg-white p-6 transition-shadow hover:shadow-lg"
            >
              <div
                className={`mb-4 inline-flex rounded-xl p-3 text-brand-navy ${accentColors[i]}`}
              >
