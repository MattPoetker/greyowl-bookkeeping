                  ...
                  <div className="border-t border-brand-lavender/10 px-6 pb-6 pt-4">
                    ...
                    {faq.hasChecklist && (
                      <div className="mt-4 flex flex-wrap gap-3">
                        <a
                          href="/personal-tax/checklist"
                          className="inline-flex items-center gap-2 rounded-xl border border-brand-sage/20 bg-brand-sage/8 px-5 py-2.5 text-sm font-semibold text-brand-navy transition-all duration-300 hover:bg-brand-sage/15"
                        >
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 rounded-xl border border-brand-lavender/20 bg-white px-5 py-2.5 text-sm font-medium text-brand-navy/60 transition-all duration-300 hover:text-brand-navy"
                        >
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
